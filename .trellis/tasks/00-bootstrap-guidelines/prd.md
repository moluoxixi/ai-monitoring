...
The developer just ran `trellis init` on this project. Populate
`.trellis/spec/` with the team's real coding conventions.
...
4. Use `trellis-spec-bootstrap` to analyze the repository and fill each target spec with real examples.
